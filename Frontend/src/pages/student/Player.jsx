...
const Player = () => {
  ...
  const getCourseData = () => {
    enrolledCourses.forEach((course) => {
      if (course._id == courseId) {
        ...
        if (Array.isArray(course.courseratings)) { // Ensure courseratings is an array
          course.courseratings.forEach((item) => { // Use forEach instead of map
  ...
  return courseData ? (
    <>
      <div className='p-4 sm:p-10 flex max-sm:flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36'>
        {/* left column */}
        ...
        {/* right column */}
        <div className='md:mt-10 rounded-t overflow-hidden'>
          {PlayerData ?
            <div>
