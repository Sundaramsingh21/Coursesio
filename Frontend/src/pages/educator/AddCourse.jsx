...
const AddCourse = () => {
  ...
  return (
    <div className='min-h-screen max-sm:overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
        ...
        <div className='flex items-center justify-between flex-wrap'>
          ...
          <div className='flex md:flex-row flex-col items-center gap-3'>
            ...
            <label htmlFor="thumbnailImage" className='flex items-center gap-3 '>
              <img src={assets.file_upload_icon} alt="" className='p-3 bg-blue-5000 rounded-2xl cursor-pointer w-20 ' />
              <input type="file" id='thumbnailImage' onChange={e => setImage(e.target.files[0])} accept='image/*' hidden />
              <img src={Image ? URL.createObjectURL(Image) : ''} alt="" className='rounded-xl' />
            </label>
          </div>
        </div>
          ...
          {showPopup && (
            <div className='fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50'>
              <div className='bg-white text-gray-700 p-4 rounded relative w-full max-w-80'>
                ...
                <button type='button' className='w-full bg-blue-400 text-white px-4 py-2 rounded' onClick={addLectures}>Add</button>
